            ...
            <div id="trigger" class="container ">
               <div class="row">
                  <div class="col-md-6  diamond_j_cont">
                     ...
                     <div class="diamond_b">
                        <img alt="" class="img-responsive"  src="assets/images/slider/ring.png">
                     </div>
                  </div>
            ...
            <div class="d-carousel-cener owl-carousel">
               <div class="dc-inner">
                  <a href="single-product.html">
                     <img alt="ring" src="assets/images/carousel/1.png" >
               ...
               <div class="dc-inner">
                  <a href="single-product.html">
                     <img alt="ring" src="assets/images/carousel/2.png" >
                     <div class="dc-containt">
                        <h2>Round</h2>
                        <p>Bar Set Anniversary Ring</p>
                     </div>
               ...
               <div class="dc-inner">
                  <a href="single-product.html">
                     <img alt="ring" src="assets/images/carousel/3.png" >
                     <div class="dc-containt">
                        <h2>Pear</h2>
                        <p>Bar Set Anniversary Ring</p>
                     </div>
               ...
               <div class="dc-inner">
                  <a href="single-product.html">
                     <img alt="ring" src="assets/images/carousel/4.png" >
                     <div class="dc-containt">
                        <h2>Radiant</h2>
                        <p>Bar Set Anniversary Ring</p>
                     </div>
               ...
               <div class="dc-inner">
                  <a href="single-product.html">
                     <img alt="ring" src="assets/images/carousel/5.png" >
                     <div class="dc-containt">
                        <h2>Ovel</h2>
                        <p>Bar Set Anniversary Ring</p>
                     </div>
                     ...
                     <div class="leftGrid">
                           ...
                           <a href="product.html">
                              <div class="gbinner imgTop">
                                 <div class="gb_img_box">
                                    <img class="img-responsive fill_img" alt="" src="assets/images/gridImage/1.png">
                                 </div>
                        ...
                        <div class="boxMain ">
                           <a href="product.html">
                              <div class="gbinner imgTop">
                                 <div class="gb_img_box">
                                    <img class="img-responsive nofill_img" alt="" src="assets/images/gridImage/2.png">
                                 </div>
                        ...
                        <div class="boxMain ">
                           <a href="product.html">
                              <div class="gbinner imgTop">
                                 <div class="gb_img_box">
                                    <img class="img-responsive fill_img" alt="" src="assets/images/gridImage/3.png">
                                 </div>
                                 <div class="gb_cont_box ">
                                    <h2>Have it your way</h2>
                                    <p><i>D-shine Jewellery Now available in white gold, rose gold or yellow gold</i></p>
                     ...
                     <div class="rightGrid">
                        <div class="boxMain ">
                           <a href="product.html">
                              <div class="gbinner imgRight clearfix">
                                 <div class="gb_img_box ">
                                    <img class="img-responsive nofill_img" alt="" src="assets/images/gridImage/4.png">
                                 </div>
                                 <div class="gb_cont_box">
                        ...
                        <div class="boxMain ">
                           <a href="product.html">
                              <div class="gbinner imgLeft clearfix">
                                 <div class="gb_img_box ">
                                    <img class="img-responsive nofill_img" alt="" src="assets/images/gridImage/5.png">
                                 </div>
                                 <div class="gb_cont_box">
                                    <h2>Smile from Ear to Ear</h2>
                                    <p><i>Choose from our exclusive collection of diamond earrings</i></p>
                        ...
                        <div class="boxMain ">
                           <a href="product.html">
                              <div class="gbinner imgTop">
                                 <div class="gb_img_box">
                                    <img class="img-responsive fill_img" alt="" src="assets/images/gridImage/6.png">
                                 </div>
                                 <div class="gb_cont_box ">
               ...
               <div class="row">
                  ...
                  <div class="col-sm-4 product">
                     <div class="productInner row m0">
                        ...
                        <div class="row m0 proName"><a href="single-product.html">Dining table</a></div>
                        <div class="row m0 proBuyBtn">
                  ...
                  <div class="col-sm-4 product">
                     <div class="productInner row m0">
                        ...
                        <div class="row m0 proName"><a href="single-product.html">wow sofa collections</a></div>
                        <div class="row m0 proBuyBtn">
                           <button class="addToCart btn">add to cart</button>
                        </div>
                     </div>
                  ...
                  <div class="col-sm-4 product">
                     <div class="productInner row m0">
                        ...
                        <div class="row m0 proName"><a href="single-product.html">bed collection</a></div>
                        <div class="row m0 proBuyBtn">
                           <button class="addToCart btn">add to cart</button>
                        </div>
                     </div>
               ...
               <div class="row">
                  <div class="tab-content testiTabContent">
                     <div role="tabpanel" class="tab-pane active" id="testi1">
                        <p><span class="t_q_start">“</span> D-Shine is really excellent site for furnitures. I am very happy with the Dshine products and dedicated services from them. Dshine is really excellent site for furnitures. <span class="t_q_end">”</span></p>
                  ...
                  <div class="col-sm-6">
                     <div class="blog_inner single">
                        <div class="blog_j_img">
                           <img alt="" class="img-responsive"  src="assets/images/blog/blog6.png">
                     ...
                     <div class="row">
                        <div class="col-sm-6">
                           <div class="blog_inner">
                              <div class="blog_j_img">
                                 <img alt="" class="img-responsive"  src="assets/images/blog/blog1.png">
                                 <div class="btn_readmore">
                                    <a  href="blog.html">Read more </a>
                                 </div>
                              </div>
                           ...
                           <div class="blog_inner">
                              <div class="blog_j_img">
                                 <img alt="" class="img-responsive"  src="assets/images/blog/blog5.png">
                                 <div class="btn_readmore">
                                    <a  href="blog.html">Read more </a>
                                 </div>
                              </div>
