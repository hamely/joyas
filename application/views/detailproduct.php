            ...
            <div class="row singleProduct">
                <div class="col-sm-7">
                    <div class="row m0 flexslider" id="productImageSlider">
                        <ul class="slides">
                            <li><img src="<?php echo base_url('assets/images/product/single/1.jpg'); ?>" alt=""></li>
                            <li><img src="<?php echo base_url('assets/images/product/single/2.jpg'); ?>" alt=""></li>
                            <li><img src="<?php echo base_url('assets/images/product/single/3.jpg'); ?>" alt=""></li>
                            <li><img src="<?php echo base_url('assets/images/product/single/4.jpg'); ?>" alt=""></li>
                            <li><img src="<?php echo base_url('assets/images/product/single/5.jpg'); ?>" alt=""></li>
                            <li><img src="<?php echo base_url('assets/images/product/single/6.jpg'); ?>" alt=""></li>
                            <li><img src="<?php echo base_url('assets/images/product/single/7.jpg'); ?>" alt=""></li>
                            <li><img src="<?php echo base_url('assets/images/product/single/8.jpg'); ?>" alt=""></li>
                        </ul>
                    </div>
                    <div class="row m0 flexslider" id="productImageSliderNav">
                        <ul class="slides">
                            <li><img class="img-thumbnail" src="<?php echo base_url('assets/images/product/single/1.jpg'); ?>" alt=""></li>
                            <li><img class="img-thumbnail" src="<?php echo base_url('assets/images/product/single/1.jpg'); ?>" alt=""></li>
                            <li><img class="img-thumbnail" src="<?php echo base_url('assets/images/product/single/1.jpg'); ?>" alt=""></li>
                            <li><img class="img-thumbnail" src="<?php echo base_url('assets/images/product/single/1.jpg'); ?>" alt=""></li>
                            <li><img class="img-thumbnail" src="<?php echo base_url('assets/images/product/single/1.jpg'); ?>" alt=""></li>
            ...
            <div class="row shortcodesRow m0">
                ...
                <div class="col-sm-3 product">
                    <div class="productInner row m0">
                        ...
                        <div class="row m0 proName"><a href="../index.php/detailproduct">colorful sofa</a></div>
